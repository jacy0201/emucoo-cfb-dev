...
import com.emucoo.manager.component.rong.messages.TxtMessage;
import com.emucoo.manager.component.rong.messages.VoiceMessage;
import com.emucoo.manager.component.rong.models.*;
...
public class Example {
	...
	public static void main(String[] args) throws Exception {
		String appKey = "vnroth0kvdlho";//替换成您的appkey
		String appSecret = "2XF06Z5BzIYN";//替换成匹配上面key的secret
