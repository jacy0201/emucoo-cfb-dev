...
public class MsgPushTool {
    ...
    private static Logger logger = LoggerFactory.getLogger(MsgPushTool.class);
    ...
    public MsgPushTool(){
        ...
        isApnsProduction = Boolean.getBoolean(env.getProperty("jiguangPush.apnsProduction"));
        isXiaomiDebug = Boolean.getBoolean(env.getProperty("xiaomiPush.isDebug"));
    ...
    private int pushJpushMsg(String title, String content, Map<String, String> extra, List<String> jpush) {
        ...
        sendno.setApnsProduction(isApnsProduction);
    ...
    private void addNotification(String title, String content, Notification.Builder builder, Map<String, String> extra) {
